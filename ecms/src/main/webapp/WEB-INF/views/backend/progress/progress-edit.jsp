...
<head>
    ...
    <script type="Text/javascript">
        ...
        var ProjectProgressJson = ${ProjectProgressJson};
        //var ProjectProgressJson = {"ProjectProgressID":"1000000113","ProjectCode":"1","StageProjectID":"1000000201","ChildStructure":"","PlanStart":"2018.03.20","PlanComplete":"2018.06.01","ActualStart":"","ActualComplete":"","Completion":"未开始","InputterID":"0000000012","InputterOfOrgID":"0000000007","InputterName":"管理员","InputDate":"2017-10-20 08:55:55Z","ModifierID":"0000000012","ModifierOfOrgID":"0000000007","ModifierName":"管理员","ModifyDate":"2017-11-06 11:12:08Z","Remark":"","DelTag":"1","CompleRate":"0","ProjectName":"研发楼一期","StageProjectName":"室外工程阶段","limit":0,"start":0,"page":0,"BeginRecordNumber":0,"EndRecordNumber":0,"SearchString":"","Search":"","q":null,"OrderByExpr":""};
        // 数据校验
        function CheckData() {
        ...
        function Save() {
            ...
            objFormData.ProjectProgressID = ProjectProgressJson.ProjectProgressID;
            $.messager.progress({ title: GNAMESPACE.Common.ProgressMsgTitle, msg: '正在保存数据。' });
            $.ajax({
                type: "POST",
                url: '/project-progress/SaveForEdit',
        ...
        jQuery(function ($) {
            ...
            GNAMESPACE.Common.SetFormData(ProjectProgressJson);
        });
    </script>
</head>
