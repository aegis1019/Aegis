...
<body class="FormBody2">
    ...
    <div id="divInputArea" >
        ...
        <div class="e-row">
            ...
            <div class="e-col4 Field">
                <label id="lbStageProjectName">&nbsp;</label> 
            </div>
         </div>
        <div class="e-row">
            ...
            <div class="e-col4 Field">
                ...
                <label id="lbChildStructure">&nbsp;</label> 
            </div>
            </div>
        <div class="e-row">
        ...
        <div class="e-row">
         ...
         <div class="e-row">
            ...
            <div class="e-col4 Field">
                ...
                <label id="lbActualStart">&nbsp;</label> 
            </div>
            </div>
         <div class="e-row">
            <div class="e-col3 FieldTitle">实际竣工日期：</div>
            <div class="e-col4 Field">
           
                <label id="lbActualComplete">&nbsp;</label> 
            </div>
            </div>
        <div class="e-row">
