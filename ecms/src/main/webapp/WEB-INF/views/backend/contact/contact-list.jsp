...
<head id="Head1">
    ...
    <script type="Text/javascript">
        ...
        function Add() {
            ...
            var strHref = '<iframe id="fmLinkManInfoAdd" name="fmLinkManInfoAdd" height="100%" width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  scrolling="yes" style="overflow-x:hidden;" src="/contact/contact-new"></iframe>';
        ...
        function Delete() {
            ...
            var strID = objSelectedRow.linkManID;
            ...
            $.messager.confirm("提示", '是否删除选中的数据？', function (e) {
                if (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/contact/contact-del",
                        contentType: "application/json",
                        data:JSON.stringify({ LinkManID: strID }),
        ...
        function Edit() {
            ...
            var strHref = '<iframe id="fmLinkManInfoEdit" name="fmLinkManInfoEdit" height="100%" width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  scrolling="yes" style="overflow-x:hidden;" src="/contact/contact-edit?LinkManID=' + strID + '"></iframe>';
        ...
        function Detail() {
            ...
            var strID = objSelectedRow.linkManID;
            var strHref = '<iframe id="fmLinkManInfoDetail" name="fmLinkManInfoDetail" height="100%" width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  scrolling="yes" style="overflow-x:hidden;" src="/contact/contact-detail?LinkManID=' + strID + '"></iframe>';
