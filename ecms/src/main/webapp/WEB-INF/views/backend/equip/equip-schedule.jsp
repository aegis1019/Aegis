...
<head id="Head1">
    ...
    <script type="Text/javascript">
        ...
        GNAMESPACE.Register('View.BasicData.Equipment.List');
        var objGrid;
        var objGridPageBar;
        ...
        function Add() {
            ...
            var strHref = '<iframe id="fmProjectInfoAdd" name="fmProjectInfoAdd" height="100%" width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  scrolling="yes" style="overflow-x:hidden;" src="/equipment/equip-new"></iframe>';
        ...
        function Delete() {
            ...
            var strID = objSelectedRow.equipmentID;
            ...
            $.messager.confirm("提示", '是否删除选中的数据？', function (e) {
                if (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/equipment/equip-del",
                        contentType: "application/json",
                        data: JSON.stringify({ EquipmentID: strID }),
        ...
        function Edit() {
            ...
            var strID = objSelectedRow.equipmentID;
            var strHref = '<iframe id="fmProjectInfoEdit" name="fmProjectInfoEdit" height="100%" width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  scrolling="yes" style="overflow-x:hidden;" src="/equipment/equip-edit?EquipmentID=' + strID + '"></iframe>';
        ...
        function Detail() {
            ...
            var strID = objSelectedRow.equipmentID;
            var strHref = '<iframe id="fmProjectInfoDetail" name="fmProjectInfoDetail" height="100%" width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  scrolling="yes" style="overflow-x:hidden;" src="/equipment/equip-detail?EquipmentID=' + strID + '"></iframe>';
...
<div id="divSearchArea" class="SearchArea">
    <table style="table-layout: fixed; width: 100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <td class="FieldTitle">设备名称：</td>
            <td class="Field">
                <input id="tbEquipmentName" class="Field1" type="text" />
            </td>
            <td>
