...
<head>
    ...
    <script type="Text/javascript">
        var StageProjectJson = ${StageProjectJson};
        // 数据校验
        function CheckData() {
        ...
        function Save() {
            ...
            objFormData.StageProjectID = StageProjectJson.StageProjectID;
            $.messager.progress({ title: GNAMESPACE.Common.ProgressMsgTitle, msg: '正在保存数据。' });
            $.ajax({
                type: "POST",
                url: '/project-phase/SaveForEdit',
        ...
        jQuery(function ($) {
            ...
            GNAMESPACE.Common.SetFormData(StageProjectJson);
        });
    </script>
</head>
