...
<head>
    ...
    <script type="Text/javascript">
        ...
        function CheckData() {       
            ...
            var FeeType=$.trim($('#cbtFeeType').val());
            if (FeeType == "") {
        ...
        function GetFormData() {
            ...
            objFormData.DesignAlterationID = DesignAlterationJson.DesignAlterationID;
            return objFormData;
        };
...
<body class="FormBody2">
    ...
    <div>      
        ...
        <div class="e-row">
            ...
            <div class="e-col4 Field">
                <input id="cbtFeeType" class="Field" type="text" />
            </div>
        </div>     
        <div class="e-row">
