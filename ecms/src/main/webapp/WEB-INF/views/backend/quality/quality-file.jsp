...
<head>
    ...
    <script type="text/javascript">
        ...
        function initGrid() {
            ...
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    { field: '', checkbox: true },
                    { field: 'AttachmentType', title: '类型', width: '10%', align: 'left', halign: 'center' },
        ...
        function check() {
            ...
            str = $.trim($('#cbbAttachmentType').combobox("getValue"));
            if (str == "") {
                $.messager.alert(GNAMESPACE.Common.AlertMsgTitle, "类型不能为空！", 'info');
                return false;
            } else {
                $("#AttachmentType").val($('#cbbAttachmentType').combobox("getValue"));
            }
...
<div id="tb" style="padding: 12px 5px 2px 5px;">
    <form id="myform" action="Upload" enctype="multipart/form-data" method="post" onsubmit="return check();">
        <div>
            ...
            类型：
            <input id="cbbAttachmentType" class="Field1" type="text" />
            文件:
            ...
            <input type="hidden" id="AttachmentType"" name="AttachmentType" />
...
<input type="hidden" id="hdid" value="Quality" />
<input type="hidden" id="hdtype" value="" />
<input type="hidden" id="hdCompanyName" value="" />
<input type="hidden" id="hdStatus" value="5" />
